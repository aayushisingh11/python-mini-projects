...
root2 = Button(
    ...
    bg="plum2",
    cursor="hand2",
    command=lambda: button_click("1.412"),
...
pie = Button(
    ...
    bg="plum2",
    cursor="hand2",
    command=lambda: button_click("3.14"),
...
log3 = Button(
    ...
    bg="plum2",
    cursor="hand2",
    command=lambda: button_click("0.4771"),
...
log2 = Button(
    ...
    bg="plum2",
    cursor="hand2",
    command=lambda: button_click("0.3010"),
...
log7 = Button(
    ...
    bg="plum2",
    cursor="hand2",
    command=lambda: button_equal("0.8450"),
